...
def run(args):
    ...
    try:
        ...
        prior_evidence.update({"trading_date":t,"replay_dates":stage_dates,"institutional_historical_coverage":f"{len(accepted)}/30",
          ...
          "reconstruction_status":"PASS","no_lookahead":"PASS","first_live_prior_stage_reconstruction":f"{sum(stages[s]['prior_stage_source']=='RECONSTRUCTED_FROM_AUTHORIZED_HISTORICAL_EVIDENCE' for s in stages)}/30",
        ...
        evidence.update({"validation_status":"PASS","trading_date":t,"institutional_historical_coverage":"30/30",
          ...
          "stage_feature_history":"7 sessions x 30 symbols PASS","stage_institutional_asof_alignment":replay_status["stage_institutional_asof_alignment"],"first_live_prior_stage_reconstruction":"30/30 PASS",
