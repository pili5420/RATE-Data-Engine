...
def replay(technical_fixture, institutional_fixture, trading_date='2026-09-10'):
    ...
    for t in technical:
        ...
        stage=build_stage_evidence(symbol=symbol,stage_inputs=stage_inputs,previous_stage='CONSOLIDATION',prior_m7=0,source_state_id='GENESIS_STATE_ID',input_snapshot_id='pending')
